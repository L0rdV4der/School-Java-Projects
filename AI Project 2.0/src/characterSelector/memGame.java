...
public class memGame extends JFrame implements ActionListener {
    ...
    public void laycards(JPanel panel) {
        ...
        for (int i = 0; i < 2 * 4; i++) { 
            ...
            cards[i / 4][i % 4] = new JButton("Flip"); 
    ...
    public void job() {
    	// write logic to loop over all cards and match them.
    	cards[0][0].doClick();
    	cards[0][1].doClick();
    	cards[0][0].doClick();
    	cards[0][0].doClick();
